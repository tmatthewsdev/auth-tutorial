...
class Auth_Group_Sitegroup extends \Auth_Group_Driver
{
	...
	{
		static::$_valid_groups = array_keys(\Config::get('siteauth.groups', array()));
	}

	protected $config = array(
		'drivers' => array('acl' => array('Siteacl'))
	);
	...
	public function get_name($group = null)
	{
		...
		return \Config::get('siteauth.groups.'.$group.'.name', null);
	}
	...
	public function get_roles($group = null)
	{
		...
		$groups = \Config::get('siteauth.groups');
